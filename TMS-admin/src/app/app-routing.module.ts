...
import {HospitalPermissionComponent} from './admin/hospital-permission/hospital-permission.component';
import {MenuPermissionComponent} from './admin/menu-permission/menu-permission.component';
...
const routes: Routes = [
  ...
  { path: 'admin',
    children: [
      { path: 'hospital', component: HospitalPermissionComponent, canActivate: [SignInGuardService] },
      { path: 'menu', component: MenuPermissionComponent, canActivate: [SignInGuardService] }
    ]
  }
];
